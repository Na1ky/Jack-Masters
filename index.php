                    ...
                    <ul class="navbar-nav ms-auto align-items-center gap-3">
                        ...
                        <?php else: ?>
                            <li class="nav-item"><a class="nav-link"
                                    href="profile.php?Username=<?= htmlspecialchars($player['Username']) ?>">Statistiche</a>
                            </li>
                            <li class="nav-item d-flex align-items-center gap-2">
                                <img id="navbarAvatar" class="navbar-avatar" src="<?= $player["Image"] ?>"
                                    alt="Avatar utente" />
        ...
        <section class="container">
            ...
            <div class="row align-items-center mb-5 bg-blackjack-hero shadow p-5 bg-dark">
                <div class="col-md-6 mb-4 mb-md-0 text-center text-md-start">
                    <img src="img/hero-section-background.png" alt="Tavolo Blackjack"
                ...
                <div class="col-md-6 d-flex flex-column justify-content-center align-items-start text-light">
                    ...
                    <p class="hero-subtitle">
                        Vinci partite, guadagna punti e accedi a tavoli sempre più esclusivi. Riuscirai a sbloccarli
                        tutti?
                    </p>
                    <?php if (!isset($_SESSION["sessionId"])): ?>
                    ...
                    <?php else: ?>
                        ...
                        <p class="mt-3 fs-6">Bentornato, <strong><?= htmlspecialchars($player["Username"]) ?></strong>!
            ...
            <div class="row text-light mb-5">
                <div class="col-md-4 mb-4">
                    <div class="card h-100 border-0 shadow-lg p-4">
                        ...
                        <p class="card-text">Ogni partita ti avvicina al prossimo livello. Nuovi tavoli, nuovi stili di
                            gioco!</p>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card bg-dark border-success shadow-sm h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text">Accedi per iniziare a giocare e iniziare la tua scalata verso
                                    tavoli sempre più prestigiosi.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="card bg-dark border-success shadow-sm h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text">Ogni vittoria ti dà punti. Più ne hai, più tavoli esclusivi
                                    sblocchi!</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="card bg-dark border-success shadow-sm h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text">Dalla sala verde alla sala dorata... ce la farai a conquistarle
                                    tutte?</p>
                            </div>
                        </div>
                    </div>
            ...
            <section class="container mb-5">
                ...
                <div id="level-display" class="text-center mb-5 p-4">
                    ...
                    $firstLevel = $levels[0];
                    ?>
                    <img id="main-level-image" src="<?= htmlspecialchars($firstLevel["ImagePath"]) ?>"
                        alt="<?= htmlspecialchars($firstLevel["Name"]) ?>" class="img-fluid rounded shadow-lg mb-3"
                        style="max-height: 450px; max-width: 100%; object-fit: contain;">
                    <h3 class="text-light mb-2 fs-2 fw-bold" id="main-level-name">
                        <?= htmlspecialchars($firstLevel["Name"]) ?></h3>
                    <p class="text-light fs-5" id="main-level-desc"><?= htmlspecialchars($firstLevel["Desc"]) ?></p>
                    <p class="text-light fs-5"><strong>Fiches richieste:</strong>
                        <?= number_format($firstLevel["MinFiches"]) ?></p>
                </div>
                ...
                <div class="level-thumbnails d-flex overflow-auto py-2 gap-4">
                    ...
                    ?>
                        <div class="thumb-wrapper" style="flex: 0 0 auto; cursor: pointer; opacity: <?= $opacity ?>;"
                            data-name="<?= htmlspecialchars($level["Name"]) ?>"
                            data-desc="<?= htmlspecialchars($level["Desc"]) ?>" data-fiches="<?= $level["MinFiches"] ?>">
                            <img src="<?= htmlspecialchars($level["ImagePath"]) ?>"
                                alt="<?= htmlspecialchars($level["Name"]) ?>" class="rounded shadow"
            ...
            <!-- Preview Carousel -->
            <div id="carouselBlackjack" class="carousel slide mb-5 shadow-lg rounded" data-bs-ride="carousel">
                <div class="carousel-inner rounded">
                    <div class="carousel-item active">
                        <img src="img/preview1.png" class="d-block w-100" alt="Anteprima Gioco 1" loading="lazy" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/preview2.png" class="d-block w-100" alt="Anteprima Gioco 2" loading="lazy" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/preview3.png" class="d-block w-100" alt="Anteprima Gioco 3" loading="lazy" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/preview4.png" class="d-block w-100" alt="Anteprima Gioco 4" loading="lazy" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/preview5.png" class="d-block w-100" alt="Anteprima Gioco 5" loading="lazy" />
                    </div>
                    <div class="carousel-item">
                        <img src="img/preview6.png" class="d-block w-100" alt="Anteprima Gioco 6" loading="lazy" />
                    </div>
                </div>
                <button class="carousel-control-prev" type="button" data-bs-target="#carouselBlackjack"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Precedente</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carouselBlackjack"
                    data-bs-slide="next">
