...
<head>
    ...
    <meta name="description" content="Registrati a Blackjack, il celebre gioco di carte da casinò. Inizia subito a giocare!">
    <meta name="keywords" content="Blackjack, casinò, carte, registrazione, gioco">

    <!-- Open Graph -->
    <meta property="og:title" content="BLACKJACK - Registrazione">
    <meta property="og:description" content="Crea un account e sfida la fortuna a Blackjack!">
    ...
    <main data-levels='<?= htmlspecialchars(json_encode($levels), ENT_QUOTES, 'UTF-8') ?>'>
        <div class="container d-flex justify-content-center align-items-center min-vh-100">
            <div class="card p-4 text-center text-light" style="max-width: 420px; width: 100%; background-color: #1b1f1d; border: 2px solid green; box-shadow: 0 0 20px rgba(255, 215, 0, 0.3);">
                ...
                <h3 class="fw-bold" style="color: green;">Unisciti al tavolo!</h3>
                <p class="text-light mb-4" style="color: #c0c0c0;">Inserisci i tuoi dati per registrarti</p>

                <form action="php/register_submit.php" method="POST">
                    <div class="mb-3 text-start">
                        <label for="username" class="form-label text-success">Username</label>
                        <input type="text" class="form-control bg-dark text-light border-success" maxlength="50" name="Username" placeholder="Il tuo nickname" required>
                    </div>
                    <div class="mb-3 text-start">
                        <label for="email" class="form-label text-success">Email</label>
                        <input type="email" class="form-control bg-dark text-light border-success" maxlength="120" name="Email" placeholder="esempio@email.com" required>
                    </div>
                    <div class="mb-3 text-start">
                    ...
                    <button type="submit" class="btn btn-lg fw-bold mt-3" style="background-color: green; color: #111;">🎰 Registrati</button>
                </form>

                <p class="mt-4">Hai già un account?
                    <a href="login.php" class="text-decoration-underline" style="color: #ff4136;">Accedi qui</a>
                </p>
            </div>
        </div>
    </main>
